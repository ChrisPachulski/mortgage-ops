...
- [ ] **MODE-03**: `property` mode invokes `scripts/property_analyze.py` (new) which orchestrates the full pipeline; never computes inline; always exits 0 with structured envelope per Phase 12 D-12-LIVE02-01 recovery contract.

...
- [ ] **Phase 2: Regulatory Reference Data & Rules Predicates** - Cited YAML + one-predicate-per-citation library (5/7 plans complete)
...
| 2. Regulatory Reference Data & Rules Predicates | 5/7 | In progress (02-01..02-05 green; Wave 3 plan 02-05 closed — Conventional PMI + Fannie LLPA + Freddie eligibility wired) | - |

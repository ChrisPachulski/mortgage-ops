...
- [ ] **Phase 8: Stress Tests & Points Breakeven** - Parameter sweeps + discount-points NPV (1/7 plans complete; Wave-0 Nyquist scaffold shipped: 13 stress + 5 points strict-xfail stubs; 502/4/19 baseline)
...
| 8. Stress Tests & Points Breakeven | 1/7 | In progress — Plan 08-00 ships the Wave-0 Nyquist gate: tests/test_stress.py 198 lines / 13 strict-xfail stubs covering STRS-01..04 + ROADMAP SC-1/2/3/5 + cross-cutting envelope-uniformity + tests/test_points.py 73 lines / 5 strict-xfail stubs covering PNTS-01..03 + ROADMAP SC-4 divergence pin + stress_fixture + points_fixture loaders extended into tests/conftest.py + 3 .gitkeep placeholders for tests/fixtures/{stress,stress/oracle,points}/. 502 passed + 4 skipped + 19 xfailed full suite (was 502+4+1; +18 xfailed exactly per Plan acceptance — 13 stress + 5 points; 0 failed; 0 errored; zero regression to Phase 7 closure baseline). 1 Rule-3 hygiene deviation (identical pattern to Phase 7 Plan 07-00 deviation #1: ruff format auto-broke long @pytest.mark.xfail decorators across 3 lines so the plan-spec single-line acceptance grep returns 0 — equivalent two-grep gate `grep -c '@pytest.mark.xfail(' && grep -c 'strict=True'` returns 13/13 stress + 5/5 points; min_lines artifact-spec values are planner heuristics; substantive criteria all pass). D-00-01..D-00-04 LOCKED decisions honored verbatim. Plans 08-01..08-06 unblocked; downstream waves flip 18 stubs across 5 wave plans (2 + 5 + 2 + 6 + 3 = 18 = total stubs). Plan 08-06 is doc-only. Final-state target: 0 Phase-8 xfails after Wave 5 closes; only 1 inherited Phase 5 ARM oracle deferral remains in the suite | 2026-05-03 |

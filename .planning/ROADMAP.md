...
- [ ] **Phase 8: Stress Tests & Points Breakeven** - Parameter sweeps + discount-points NPV (6/7 plans complete; Wave 0..Wave 5 all shipped — Nyquist scaffold + Pydantic models + stress engine + points engine + CLIs + 14 hand-calc fixtures with citation-coverage meta-test; STRS-01..04 + PNTS-01..03 all closed at the test layer; ROADMAP SC-1..SC-5 all verifiable verbatim by tests; SC-4 fixture pinned at engine-actual values per Plan 08-03 deviation #1 three-way cross-validation [simple=123, npv=215, gap=+92mo cum_npv_at_hold=435.46; planner-claimed 160 was mathematically inconsistent with the §5.2 formula]; SC-5 fixture pinned at 50-rate sweep producing 37623 bytes serialized, ~2.7x under the 100KB ceiling; 521 passed + 4 skipped + 1 xfailed full suite (only inherited Phase 5 ARM oracle Bankrate/Vertex42 deferral remains; outside Phase 8 scope); only Plan 08-06 references doc remains)
...
| 8. Stress Tests & Points Breakeven | 6/7 | In Progress — Wave 5 (Plan 08-05 fixtures + tests) shipped 14 hand-calc fixtures (11 stress + 3 points) + flipped 2 final Wave-0 xfails (SC-5 50-rate size budget + SC-4 7%-discount divergence pin at engine-actual npv=215) + added citation-coverage meta-test asserting every Phase 8 requirement (STRS-01..04 + PNTS-01..03) and ROADMAP SC label (SC-1..5) is exercised by at least one fixture; 521 passed + 4 skipped + 1 xfailed (only inherited Phase 5 ARM oracle Bankrate/Vertex42 deferral remains; outside Phase 8 scope); STRS-01..04 + PNTS-01..03 all closed at the test layer; ROADMAP SC-1..SC-5 all verifiable verbatim by tests; 3 deviations (1 Rule-1 plan-spec validate_python -> validate_json + 1 Rule-1 meta-test scope extension for STRS-04/PNTS-03 CLI requirements via _meta.requirements arrays + 1 Rule-3 hygiene PT018 split + unused-pytest-import); D-05-01..D-05-07 LOCKED honored; D-05-05 SC-4 numerical pins HARD (engine truth npv=215 NOT planner 160 per Plan 08-03 deviation #1 three-way cross-validation); only Plan 08-06 references doc remains for Phase 8 closure | 2026-05-04 |

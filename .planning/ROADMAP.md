...
| 6. Refinance NPV | 4/7 | In-progress — 06-00 Wave 0 + 06-01 Wave 1 + 06-02 Wave 2 + 06-03 Wave 3 complete; lib/refinance.py 1097 lines (6 Pydantic models + SC-4 sign-validator + 4 private helpers + 2 Loan constructors + cashflow builder + evaluate_rate_and_term body + after-tax tax-shield branch + evaluate_cash_out body + _compute_tax_shield_cashflows helper [D-09 + RUL-11] + isinstance-based public evaluate() dispatcher + warnings.catch_warnings/StaleReferenceWarning capture in BOTH paths + Oracle 1/2/3 pinned NPV via Decimal equality); engine layer fully operational — NO NotImplementedError stubs remain; 442 passed + 4 skipped + 20 xfailed full suite; mypy --strict + ruff clean; Wave 4 Plan 06-04 CLI scripts/refi_npv.py unblocked at engine level | - |

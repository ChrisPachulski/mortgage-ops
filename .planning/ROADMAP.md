...
- [ ] **Phase 8: Stress Tests & Points Breakeven** - Parameter sweeps + discount-points NPV (5/7 plans complete; Wave 0 Nyquist scaffold + Wave 1 Pydantic models + Wave 2 stress engine + Wave 3 points engine + Wave 4 CLIs all shipped; STRS-01..04 + PNTS-01..03 closed at the math + CLI layers; ROADMAP SC-1 + SC-2 verbatim CLI invocation operational [--mode rate-shock --rates 0.06,0.065,0.07,0.075,0.08 --input <file>; --mode income-shock --reductions 0.05,0.10,0.20 --input <file>]; ROADMAP SC-5 summary-before-rows + SC-4 simple-vs-NPV-side-by-side both pinned at the Pydantic model + engine + CLI layers; scripts/stress_test.py 193 lines + scripts/points_breakeven.py 131 lines mirror scripts/arm_simulate.py + scripts/apr_reg_z.py shape verbatim; 518/4/3 baseline; remaining 3 xfailed = 1 Plan-08-05 SC-4 points divergence-pin fixture + 1 Plan-08-05 SC-5 stress size-budget fixture + 1 inherited Phase 5 ARM oracle Bankrate/Vertex42 deferral [outside Phase 8 scope]; CRITICAL pre-emptive flag for Plan 08-05 author: planner-claimed '160 months at 7% NPV breakeven' is mathematically wrong; engine produces 215 cross-validated against numpy_financial.nper + closed-form annuity + engine walk; Plan 08-05 SC-4 divergence-pin fixture must use 215 OR re-parameter)
...
| 8. Stress Tests & Points Breakeven | 5/7 | 5/7 | In Progress|  |
